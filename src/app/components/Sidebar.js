  ...
  return (
    <div className=" h-screen bg-gray-800 w-20 md:w-40 lg:w-60 border-r p-6 border-gray-500 text-white flex flex-col ">
      ...
      <nav className="flex flex-col space-y-4">
        ...
        {/* <Link href="/search"> */}
          <div className="text-white flex  cursor-no-drop items-center justify-center md:justify-start space-x-0 md:space-x-3 p-2 rounded-lg hover:bg-gray-700">
            <FontAwesomeIcon icon={faSearch} className="w-6 h-6" />
            <span className="hidden md:block lg:block">Search</span>
          </div>
        {/* </Link> */}
        {/* <Link href="/explore"> */}
          <div className="text-white flex items-center cursor-no-drop justify-center hover:bg-gray-700  md:justify-start space-x-0 md:space-x-3 p-2 rounded-lg hover:bg-gray-700">
            <FontAwesomeIcon icon={faCompass} className="w-6 h-6" />
            <span className="hidden md:block lg:block">Explore</span>
          </div>
        {/* </Link> */}
        {/* <Link href="/favorites"> */}
  <div className="text-white flex items-center cursor-no-drop	justify-center md:justify-start space-x-0 md:space-x-3 p-2 rounded-lg hover:bg-gray-700">
...
{/* </Link> */}
        ...
        {/* <Link href="/profile"> */}
          <div className="text-white flex items-center justify-center md:justify-start space-x-0 md:space-x-3 p-2 rounded-md hover:bg-gray-700 cursor-no-drop">
